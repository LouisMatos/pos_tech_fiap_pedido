...
--Pedidos
INSERT INTO PEDIDOS (ESTADO, VALOR_PEDIDO, DATA_PEDIDO, ID_CLIENTE, NUMERO_PEDIDO, STATUS_PAGAMENTO, ENVIADO_COZINHA) SELECT * FROM (SELECT 0, 194.39, TO_TIMESTAMP('2023-10-11 20:31:56.557', 'YYYY-MM-DD HH24:MI:SS.MS'), 2, 'ZWDRLA' , 0, false) AS tmp WHERE NOT EXISTS (SELECT id_pedido FROM pedidos WHERE id_pedido = 1) LIMIT 1;
INSERT INTO PEDIDOS (ESTADO, VALOR_PEDIDO, DATA_PEDIDO, ID_CLIENTE, NUMERO_PEDIDO, STATUS_PAGAMENTO, ENVIADO_COZINHA) SELECT * FROM (SELECT 1, 190.79, TO_TIMESTAMP('2023-10-11 20:32:52.618', 'YYYY-MM-DD HH24:MI:SS.MS'), 1, 'BWDRL1' , 1, false) AS tmp WHERE NOT EXISTS (SELECT id_pedido FROM pedidos WHERE id_pedido = 2) LIMIT 1;
INSERT INTO PEDIDOS (ESTADO, VALOR_PEDIDO, DATA_PEDIDO, ID_CLIENTE, NUMERO_PEDIDO, STATUS_PAGAMENTO, ENVIADO_COZINHA) SELECT * FROM (SELECT 2, 81.37,  TO_TIMESTAMP('2023-10-11 20:33:21.251', 'YYYY-MM-DD HH24:MI:SS.MS'), 3, 'FWDR20' , 1, false)  AS tmp WHERE NOT EXISTS (SELECT id_pedido FROM pedidos WHERE id_pedido = 3) LIMIT 1;
INSERT INTO PEDIDOS (ESTADO, VALOR_PEDIDO, DATA_PEDIDO, ID_CLIENTE, NUMERO_PEDIDO, STATUS_PAGAMENTO, ENVIADO_COZINHA) SELECT * FROM (SELECT 3, 169.17, TO_TIMESTAMP('2023-10-11 20:52:51.781', 'YYYY-MM-DD HH24:MI:SS.MS'), 4, 'ZTDR3A' , 0, false) AS tmp WHERE NOT EXISTS (SELECT id_pedido FROM pedidos WHERE id_pedido = 4) LIMIT 1;
INSERT INTO PEDIDOS (ESTADO, VALOR_PEDIDO, DATA_PEDIDO, ID_CLIENTE, NUMERO_PEDIDO, STATUS_PAGAMENTO, ENVIADO_COZINHA) SELECT * FROM (SELECT 0, 169.17, TO_TIMESTAMP('2023-10-11 20:52:51.781', 'YYYY-MM-DD HH24:MI:SS.MS'), 4, 'ZTFR3A' , 2, false) AS tmp WHERE NOT EXISTS (SELECT id_pedido FROM pedidos WHERE id_pedido = 5) LIMIT 1;
